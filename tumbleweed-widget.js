document.write('<div id="mapwrapper" style="position:relative; width:700px; height:425px">');
...
if (website_id == "tumbleweed") {
	  ...
	  document.getElementById('headerimg').style.left='170px';
	  }
  else {
	  	document.getElementById('mapwrapper').style.width='600px';
	  	document.getElementById('map').style.width='590px';
		document.getElementById('headerimg').style.left='110px';
	   }
